...
while True:
    ...
    cv2.line(frame1, (50, 550), (1200, 550), (255, 127, 0), 2)
    ...
    for (i, c) in enumerate(contours):
        ...
        for (x, y) in detect:
            ...
            counter += 1
            cv2.line(frame1, (25, 550), (12, 550), (0, 127, 255), 3)
            detect.remove((x, y))
            print("Vehicle Counter: " + str(counter))

    cv2.putText(frame1, "VEHICLE COUNTER: " + str(counter), (450, 70), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), )
